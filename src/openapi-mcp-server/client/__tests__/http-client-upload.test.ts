...
// Mock FormData class with proper method mocks
...
describe("HttpClient File Upload", () => {
  ...
  it("should handle file uploads with FormData", async () => {
    ...
    expect(mockAppend).toHaveBeenCalledWith("file", mockFileStream);
    expect(mockAppend).toHaveBeenCalledWith("description", "Test file");
  ...
  it("should handle multiple file uploads", async () => {
    ...
    expect(mockAppend).toHaveBeenCalledWith("file1", mockFileStream1);
    expect(mockAppend).toHaveBeenCalledWith("file2", mockFileStream2);
    expect(mockAppend).toHaveBeenCalledWith("description", "Test files");
    expect(mockApiInstance.uploadFile).toHaveBeenCalledWith(
      {},
      expect.any(Object),
      { headers: mockFormDataHeaders }
